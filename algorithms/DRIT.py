...
# This is the implementation of DTIR++ in PyTorch
...
class DRITplusplus(nn.Module):
  def __init__(self, opts):
    super(DRITplusplus, self).__init__()
    ...
    if self.concat:
      self.enc_a = E_attr_concat(opts.input_dim_a, opts.input_dim_b, self.nz, \
